        ...
        <section class="bg-gray-100 pt-2">
            <div class="container mx-auto">
                <p class="text-left px-4 pt-2 text-gray-400"><a href="{{ route('index') }}"
                        class="text-blue-600 hover:underline">ホーム</a><span class="px-2">&gt</span>CONTACT</p>
                    ...
                    <form action="{{ route('contact') }} " method="post">
                        ...
                        <div class="mb-4">
                            <label for="name" class="block text-left p-1 my-1 font-medium">お名前<span
                                    class="text-white text-xs bg-yellow-400 mx-2 py-1 px-2">必須</span>
                                @if ($errors->has('name'))
                            ...
                            <input id="name" name="name"
                                ...
                                type="text" placeholder="例）田中太郎" value="{{ old('name') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="name_kana" name="name_kana"
                                class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border"
                                type="text" placeholder="例）タナカタロウ" value="{{ old('name_kana') }}">

                        </div>
                        <div class="mb-4">
                            <label for="phone" class="block text-left p-1 my-1 font-medium">電話番号
                                <span>
                                    @error('phone')
                                        <span class="text-red-400">{{ $message }}</span>
                                    @enderror
                            ...
                            <input id="phone" name="phone"
                                class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border"
                                type="text" placeholder="例）0312345678" value="{{ old('phone') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="email" name="email"
                                class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border"
                                type="email" placeholder="info@example.com" value="{{ old('body') }}">


                        </div>
                        <div class="mb-4">
                            <label for="body" class="block text-left p-1 my-1 font-medium">お問い合わせ内容
                                <span class="text-white text-xs bg-yellow-400 mx-2 py-1 px-2">必須</span>
                                @error('body')
                                    <span class="text-red-400">{{ $message }}</span>
                                @enderror
                            </label>
                        ...
                        <div class="text-center">
                            <p>送信される際は、<a href="#" class="text-blue-600 hover:underline">個人情報保護方針</a>に同意したものとします。
                            </p>
                            <button
